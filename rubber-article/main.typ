...
#show: article.with(
  ...
  eq-chapterwise: true, eq-numbering: "(1.1)", header-display: true, header-title: "The Title of the Paper", lang: "en", page-margins: 1.75in, page-paper: "a4",
)

// Frontmatter
#maketitle(
  title: "The Title of the Paper", authors: ("Authors Name",), date: datetime
  .today()
...
#lorem(60) Here the vspace function is used to add some space between paragraphs
on demand to

#vspace
#lorem(100)
$
  x_(1,2) = (-b plus.minus sqrt(b^2 - 4 a b))/ (2 a)
$
#lorem(100)
...
#figure (rect(width: 4cm, height: 3cm), caption: shortcap([A short caption of
the image], [#lorem(30)]))
...
#figure(
  ctable(cols: "l|cr", [A], [B], [C], ..range(1, 16).map(str)), caption: shortcap("Short caption", "This is a custom table"),
)
